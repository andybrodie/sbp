...
{
    /// <summary>
    ///   View model to represent a single item of a <see cref="SelectedAction" />.
    /// </summary>
    /// <remarks>
    ///   <para> This class does not perform any explicit localization, the caller is responsible for this. </para>
    ///   <para> To understand the relationship between <see cref="TargetPage" /> , <see cref="TargetUri" /> and <see
    ///    cref="Invoke" /> see <see cref="MenuPageModel" /> </para>
    /// </remarks>
